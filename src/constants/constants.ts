...
export const icons = {
  ...
  resetTranslation: `<svg fill="#333" width="12" height="12" viewBox="0 0 512 512" data-name="Layer 1" id="Layer_1" xmlns="http://www.w3.org/2000/svg">
